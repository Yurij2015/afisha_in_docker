...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 12 2020 г., 17:54
...
(3, 'Бойко Ольга', 'Артистка театра.\r\n\r\nВ 2002 году окончила Новосибирский колледж культуры и искусства\r\n\r\nВ театре работает с 2008 года.\r\n\r\nРоли в спектаклях нашего театра:\r\n\r\nГостья королевы – «Двенадцать месяцев» С.Маршака;\r\n\r\nСова – «Винни-Пух и все-все-все!» Д.Нуянзина;\r\n\r\nЖена купца Бородавкина – «Оазис.А» Е.Сташкова;\r\n\r\nМать-убийца – «Взаперти»  А.Гумеровой.', 'uploads/Boyko-Olga.jpg'),
(4, 'Карасевич Софья', 'Артистка театра.\r\n\r\nВ 2018 году окончила ГОУ СПО Красноярский краевой колледж культуры и искусства.\r\n\r\nВ театре работает с октября 2018 года.\r\n\r\nРоли в спектаклях нашего театра:\r\n\r\nВолонтёр – «Оазис.А.» Е.Сташкова;\r\n\r\nДочка – «Двенадцать месяцев» С.Маршака;\r\n\r\nЛюба – «Взаперти»  А.Гумеровой;\r\n\r\nЛиса – «Лев Васька» П.Морозова.', 'uploads/Красевич.jpg'),
(5, 'Кончиц Анжелика', 'Артистка театра.\r\n\r\nВ 2015 году окончила ГОУ СПО Красноярский краевой колледж культуры и искусств.  \r\n\r\nВ театре работает с 2015 года.\r\n\r\nРоли в спектаклях нашего театра:\r\n\r\nМарютка 2 – «Сорок первый»  Б.Лавренёва;\r\n\r\nХимка – «Женитьба Бальзаминова» А.Н. Островского;\r\n\r\nЮля – «Долгожитель» Б.Рацера и В.Константинова;\r\n\r\nСветлана – «Два мужа по цене одного» Л.Моцарь;\r\n\r\nАнфиса – «Анфиса-краса и сказочные чудеса» Е.Птичкина;\r\n\r\nГостья королевы – «Двенадцать месяцев» С.Маршака;\r\n\r\nДжил Тэннер – «Эти свободные бабочки» Л.Герша.', 'uploads/Konchits-Anzhelika (1).jpg');
...
--
ALTER TABLE `artists`
  MODIFY `idartist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `repertoire`
  MODIFY `idrepertoire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
